...
WINDOWS = [
    ...
    {'window_id': 'G-LIV-NBALC', 'room_or_zone': 'living / TV wall -> north balcony',
     ...
     'source': 'owner confirmed glass door centered on TV-wall north section; DWG gap y12050-12900 includes upper frame/corner return — clear opening placed owner-centered',
     'confidence': 'HIGH', 'measurement_status': 'CONFIRMED',
     'host_wall_id': 'W-INT-X7900-U-TV', 'opening_rect_mm': [7800, 11800, 7900, 12650],
     'door_type': 'glass door (leaf type field-check)', 'clear_width_mm': 850,
     'notes': 'the door previously mis-recorded as D-BALC-W on west parapet — same physical door, corrected location; top 150mm of DWG gap = frame/corner return kept as wall, not counted in clear opening'},
...
openings = [
    ...
    {'id': 'G-LIV-NBALC', 'kind': 'glazing_door', 'meas_zone': [[6500, 13136], [6600, 13986]],
     'status': 'EXISTING_CONFIRMED', 'note': 'TV wall -> north balcony glass door, 850mm clear opening centered on owner-marked section (was mis-read as west-parapet door)'},
