...
D['scheme']='A6 functional detail with thin refrigerator: pocket door, bathrooms, wardrobes, and window areas'
...
D['status']='A6 concept; original PNG walls preserved; thin refrigerator envelope and functions checked; construction details pending.'
...
main+=text(200,83,'方案 A6 · 薄型冰箱尺寸校核版',31,anchor='start',weight=600)
main+=text(200,111,'3 卧室 · 餐客厅 · 1 厨房 · 2 卫生间 · 薄型冰箱＋次卫内嵌推拉门',19,anchor='start',color='#74847a')
