...
- **PREC-015** Apartment Renovation in Sants — relevance 0.6853; evidence confidence 0.85; tags: before-after, child-friendly, existing-structure, flexible-living, kitchen-adjacency, multigenerational, open-living-dining, renovation; [source](https://www.archdaily.com/985123/apartment-renovation-in-sants-parramon-plus-tahull-arquitectes)
- **PREC-017** Renovation of Sofia's apartment — relevance 0.6525; evidence confidence 1.00; tags: before-after, child-friendly, existing-structure, flexible-living, kitchen-adjacency, multigenerational, open-living-dining, renovation; [source](https://www.archdaily.com/1029144/renovation-of-sofias-apartment-pedro-ignacio-yanez-plus-carolina-recondo)
...
- **PREC-005** Residential Extension MF Pavilion — relevance 0.8985; evidence confidence 0.99; tags: child-friendly, existing-structure, flexible-living, floor-plan, multigenerational, open-living-dining, renovation; [source](https://www.archdaily.com/920031/residential-extension-mf-pavilion-guillermo-tirado-gzz-architects)
...
- **PREC-055** Renovation of the Jiakaxia Ancient Courtyard — relevance 0.4471; evidence confidence 0.85; tags: balcony-connected, before-after, courtyard, daylight, existing-structure, flexible-living, renovation, split-level, split-level-courtyard, visual-connection; [source](https://www.archdaily.com/1031087/renovation-of-the-jiakaxia-ancient-courtyard-hypersity-architects)

## 6. Applicable patterns

- **PAT-AGE-01 — STEP-FREE-ALTERNATE-ROUTE**; evidence: PREC-004: Captured metadata carries shared tags aging-in-place, step-free-route and floor_plan_available=true. (HIGH); PREC-009: Captured metadata carries shared tags aging-in-place, step-free-route and floor_plan_available=true. (HIGH); PREC-030: Captured metadata carries shared tags aging-in-place, step-free-route and floor_plan_available=false. (MEDIUM); PREC-013: Captured metadata carries shared tags split-level and floor_plan_available=true. (MEDIUM); PREC-014: Captured metadata carries shared tags split-level and floor_plan_available=true. (MEDIUM)
- **PAT-AGE-02 — VISIBLE-SOCIAL-ROUTE**; evidence: PREC-002: Captured metadata carries shared tags clear-circulation, visual-connection and floor_plan_available=true. (HIGH); PREC-006: Captured metadata carries shared tags clear-circulation, visual-connection and floor_plan_available=true. (HIGH); PREC-050: Captured metadata carries shared tags clear-circulation, visual-connection and floor_plan_available=false. (MEDIUM); PREC-004: Captured metadata carries shared tags aging-in-place and floor_plan_available=true. (MEDIUM); PREC-009: Captured metadata carries shared tags aging-in-place and floor_plan_available=true. (MEDIUM)
- **PAT-BED-01 — BEDROOM CLEAR-SIDE ROUTE**; evidence: PREC-004: Captured metadata carries shared tags aging-in-place, elderly-bedroom and floor_plan_available=true. (HIGH); PREC-009: Captured metadata carries shared tags aging-in-place, elderly-bedroom and floor_plan_available=true. (HIGH); PREC-030: Captured metadata carries shared tags aging-in-place, elderly-bedroom and floor_plan_available=false. (MEDIUM); PREC-057: Captured metadata carries shared tags aging-in-place, elderly-bedroom and floor_plan_available=false. (MEDIUM); PREC-002: Captured metadata carries shared tags clear-circulation and floor_plan_available=true. (MEDIUM)
- **PAT-CIR-01 — FURNITURE-FREE CIRCULATION SPINE**; evidence: PREC-002: Captured metadata carries shared tags clear-circulation and floor_plan_available=true. (MEDIUM); PREC-004: Captured metadata carries shared tags aging-in-place and floor_plan_available=true. (MEDIUM); PREC-006: Captured metadata carries shared tags clear-circulation and floor_plan_available=true. (MEDIUM); PREC-009: Captured metadata carries shared tags aging-in-place and floor_plan_available=true. (MEDIUM); PREC-027: Captured metadata carries shared tags clear-circulation and floor_plan_available=true. (MEDIUM)
- **PAT-KIT-01 — RETAINED-KITCHEN WORKFLOW**; evidence: PREC-002: Captured metadata carries shared tags existing-structure, kitchen-adjacency and floor_plan_available=true. (HIGH); PREC-003: Captured metadata carries shared tags existing-structure, kitchen-adjacency and floor_plan_available=true. (HIGH); PREC-007: Captured metadata carries shared tags existing-structure, kitchen-adjacency and floor_plan_available=true. (HIGH); PREC-008: Captured metadata carries shared tags existing-structure, kitchen-adjacency and floor_plan_available=true. (HIGH); PREC-010: Captured metadata carries shared tags existing-structure, kitchen-adjacency and floor_plan_available=true. (HIGH)
- **PAT-KIT-02 — COMPACT-WORK-TRIANGLE**; evidence: PREC-002: Captured metadata carries shared tags clear-circulation, kitchen-adjacency and floor_plan_available=true. (HIGH); PREC-003: Captured metadata carries shared tags kitchen-adjacency and floor_plan_available=true. (MEDIUM); PREC-006: Captured metadata carries shared tags clear-circulation and floor_plan_available=true. (MEDIUM); PREC-007: Captured metadata carries shared tags kitchen-adjacency and floor_plan_available=true. (MEDIUM); PREC-008: Captured metadata carries shared tags kitchen-adjacency and floor_plan_available=true. (MEDIUM)
- **PAT-LIV-01 — CLEAR CENTRAL LIVING CORE**; evidence: PREC-001: Captured metadata carries shared tags child-friendly and floor_plan_available=true. (MEDIUM); PREC-002: Captured metadata carries shared tags clear-circulation and floor_plan_available=true. (MEDIUM); PREC-003: Captured metadata carries shared tags child-friendly and floor_plan_available=true. (MEDIUM); PREC-005: Captured metadata carries shared tags child-friendly and floor_plan_available=true. (MEDIUM); PREC-006: Captured metadata carries shared tags clear-circulation and floor_plan_available=true. (MEDIUM)
- **PAT-BED-02 — STUDY + BACKUP SLEEPING**; evidence: PREC-007: Captured metadata carries shared tags flexible-living, study-guest-hybrid and floor_plan_available=true. (HIGH); PREC-008: Captured metadata carries shared tags flexible-living, study-guest-hybrid and floor_plan_available=true. (HIGH); PREC-010: Captured metadata carries shared tags flexible-living, study-guest-hybrid and floor_plan_available=true. (HIGH); PREC-031: Captured metadata carries shared tags flexible-living, study-guest-hybrid and floor_plan_available=false. (MEDIUM); PREC-048: Captured metadata carries shared tags flexible-living, study-guest-hybrid and floor_plan_available=false. (MEDIUM)
