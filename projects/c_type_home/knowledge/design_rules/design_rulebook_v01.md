...
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
...
- **Source:** [SRC-PRACTICE-ERGONOMICS](https://www.wbdg.org/design-objectives/accessible) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.
...
- **Classification:** `TO_VERIFY_LOCAL_CODE`; source strength `STRONG`; automatic gate `false
...
- **Classification:** `PROJECT_CONSTRAINT`; source strength `STRONG`; automatic gate `true
...
- **Classification:** `TO_VERIFY_LOCAL_CODE`; source strength `MEDIUM`; automatic gate `false
...
- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `TECHNICAL_REFERENCE`; source strength `STRONG`; automatic gate `false
...
- **Type / priority:** `TECHNICAL_GUIDELINE` / `HIGH`
- **Classification:** `TECHNICAL_REFERENCE`; source strength `STRONG`; automatic gate `true
...
- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `STRONG`; automatic gate `false
...
- **Type / priority:** `TO_VERIFY_PRODUCT` / `HIGH`
- **Classification:** `TO_VERIFY_PRODUCT`; source strength `WEAK`; automatic gate `false
- **Statement:** After an actual projector or laser-TV model is selected, verify throw, sightline, image size, glare and mounting constraints before fixing the media wall.
- **Planning target:** qualitative
- **Applies when:** projector_or_laser_tv, selected_product
- **Tags:** projector-media, non-tv-centric
- **Source:** [SRC-PROJECTOR-PRODUCT](https://www.projectorcentral.com/) — project
- **Notes:** No device model is selected; this rule cannot act as a hard automatic failure.
...
- **Type / priority:** `TO_VERIFY_PRODUCT` / `HIGH`
- **Classification:** `TO_VERIFY_PRODUCT`; source strength `WEAK`; automatic gate `false
- **Statement:** After the actual projector or laser-TV model and image size are selected, verify viewing distance and test the furniture arrangement at full scale.
- **Planning target:** qualitative
- **Applies when:** projector_or_laser_tv, selected_product
...
### SPC-HIER-001 — public-zone hierarchy

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Make the entry, living, dining and kitchen sequence legible as a hierarchy of arrival, activity and support rather than four competing centers.
- **Planning target:** qualitative
- **Applies when:** open_public_zone
- **Tags:** spatial-composition, visual-hierarchy
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-HIER-002 — focal hierarchy

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Choose one primary focal condition for a view and give secondary focal points a quieter visual weight.
- **Planning target:** qualitative
- **Applies when:** multi_focal_room
- **Tags:** spatial-composition, focal-hierarchy
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-GRP-003 — furniture grouping

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Group seats and tables around a shared activity or view so that each piece participates in a readable composition.
- **Planning target:** qualitative
- **Applies when:** seating_group
- **Tags:** spatial-composition, furniture-grouping
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-GRP-004 — conversation grouping

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Provide at least one face-to-face conversation relationship that is not dependent on the projection axis.
- **Planning target:** qualitative
- **Applies when:** conversation, projector_living
- **Tags:** spatial-composition, furniture-grouping, conversation
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-SCL-005 — scale and proportion

- **Type / priority:** `BEST_PRACTICE` / `MEDIUM`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Check furniture scale against the room volume and adjacent openings; do not let one oversized piece make the rest read as leftovers.
- **Planning target:** qualitative
- **Applies when:** furniture_selection
- **Tags:** spatial-composition, scale-proportion
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-SCL-006 — scale transition

- **Type / priority:** `BEST_PRACTICE` / `MEDIUM`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Use deliberate scale transitions between fixed cabinetry, large seating and small movable objects.
- **Planning target:** qualitative
- **Applies when:** mixed_furniture_scale
- **Tags:** spatial-composition, scale-proportion
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-NEG-007 — negative space

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Treat negative space as an intentional shape with edges, access and a visual role rather than as unfilled remainder.
- **Planning target:** qualitative
- **Applies when:** open_public_zone
- **Tags:** spatial-composition, negative-space
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-NEG-008 — leftover wedges

- **Type / priority:** `BEST_PRACTICE` / `MEDIUM`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Investigate leftover wedges and narrow gaps created by furniture before accepting them as useful space.
- **Planning target:** qualitative
- **Applies when:** furniture_layout
- **Tags:** spatial-composition, negative-space
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-BAL-009 — spatial balance

- **Type / priority:** `BEST_PRACTICE` / `MEDIUM`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Balance visual weight across the room while allowing asymmetry when it is anchored by a clear edge, axis or view.
- **Planning target:** qualitative
- **Applies when:** furniture_layout
- **Tags:** spatial-composition, spatial-balance
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-BAL-010 — visual weight

- **Type / priority:** `BEST_PRACTICE` / `MEDIUM`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Avoid concentrating all tall, dark or fixed elements on one side unless the opposite side has a deliberate counterweight.
- **Planning target:** qualitative
- **Applies when:** open_public_zone
- **Tags:** spatial-composition, spatial-balance
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
...
### SPC-EDGE-011 — architectural edge alignment

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Align major furniture with walls, bays, glazing lines or service edges when that alignment clarifies the room rather than hiding an opening.
- **Planning target:** qualitative
- **Applies when:** architectural_edge
- **Tags:** spatial-composition, edge-alignment
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-EDGE-012 — opening relationship

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Keep furniture-to-wall relationships legible at doors, windows and bay projections; do not use furniture to erase architectural evidence.
- **Planning target:** qualitative
- **Applies when:** window_or_door
- **Tags:** spatial-composition, edge-alignment, existing-structure
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-SIGHT-013 — main visual axis

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Protect the primary visual axis from entry toward the most valuable view or social destination before adding decorative objects.
- **Planning target:** qualitative
- **Applies when:** entry_view
- **Tags:** spatial-composition, sightlines
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-SIGHT-014 — daylight and view

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Preserve daylight and balcony or courtyard views as part of the composition, not only as a circulation requirement.
- **Planning target:** qualitative
- **Applies when:** balcony_connected, window_present
- **Tags:** spatial-composition, sightlines, daylight
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-ZONE-015 — zone definition

- **Type / priority:** `BEST_PRACTICE` / `MEDIUM`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Define living, dining, child activity and passage zones with edges, orientation, lighting or furniture grouping rather than arbitrary rectangles alone.
- **Planning target:** qualitative
- **Applies when:** open_plan
- **Tags:** spatial-composition, zone-definition
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-ZONE-016 — soft boundaries

- **Type / priority:** `BEST_PRACTICE` / `MEDIUM`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Use a soft boundary only when it supports the intended relationship; do not create pseudo-walls that block sightlines without giving privacy or storage.
- **Planning target:** qualitative
- **Applies when:** open_plan
- **Tags:** spatial-composition, zone-definition, sightlines
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-RHY-017 — rhythm and repetition

- **Type / priority:** `BEST_PRACTICE` / `LOW`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Repeat a line, material, opening rhythm or furniture proportion deliberately so the public zone reads as one composition.
- **Planning target:** qualitative
- **Applies when:** open_public_zone
- **Tags:** spatial-composition, rhythm-repetition
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-RHY-018 — repetition with variation

- **Type / priority:** `BEST_PRACTICE` / `LOW`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Allow controlled variation inside a repeated rhythm so the room does not become either visually noisy or mechanically uniform.
- **Planning target:** qualitative
- **Applies when:** material_or_furniture_set
- **Tags:** spatial-composition, rhythm-repetition
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-FLOAT-019 — floating furniture reason

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Do not float a sofa, table or chair in open space without a clear reason such as a view, conversation group, route edge or zone definition.
- **Planning target:** qualitative
- **Applies when:** open_plan
- **Tags:** spatial-composition, furniture-grouping, negative-space
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.

### SPC-FLOAT-020 — anchor or remove

- **Type / priority:** `BEST_PRACTICE` / `HIGH`
- **Classification:** `DESIGN_HEURISTIC`; source strength `MEDIUM`; automatic gate `false
- **Statement:** Anchor an isolated object to an architectural edge or a meaningful group, or remove it from the composition.
- **Planning target:** qualitative
- **Applies when:** furniture_layout
- **Tags:** spatial-composition, furniture-grouping, edge-alignment
- **Source:** [SRC-PRACTICE-SPATIAL](https://www.architecture.com/knowledge-and-resources/resources-landing-page) — general_reference
- **Notes:** Use as a design check; verify the actual room, product and local requirements.
...
- **P-OWNER-COUPLE** `PROJECT_PREFERENCE` — The permanent daily residents are the owner and his mother; wife, child and wider family are periodic residents or visitors and must be accommodated without making the daily plan hotel-like. (status: `CONFIRMED`)
